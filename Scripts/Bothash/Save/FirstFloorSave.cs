...
public class FirstFloorSave: MonoBehaviour
{
    ...
    public static FirstFloorSave Instance { get; private set; }
    ...
    void LoadGameData()
    {
        ...
        if (File.Exists(Application.persistentDataPath + "/GameData/game_Data1.botHash"))
        {
            FileStream fileLoad = File.Open(Application.persistentDataPath + "/GameData/game_Data1.botHash", FileMode.Open);
    ...
    public void Save()
    {
        ...
        FileStream file = File.Create(Application.persistentDataPath + "/GameData/game_Data1.botHash");
